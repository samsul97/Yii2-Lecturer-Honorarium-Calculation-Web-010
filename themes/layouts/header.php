...
<?php if (Yii::$app->user->identity->id_user_role == 1): ?>
    ...
    <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
           ...
           <?php endif ?>
           <?php if (User::isDosen()): ?>
               <?= User::getFotoDosen(['class' => 'user-image']); ?>
           <?php endif ?>
           <?php if (User::isAkademik()): ?>
               <?= User::getFotoAkademik(['class' => 'user-image']); ?>
           <?php endif ?>
           <?php if (User::isKetuajurusan()): ?>
               <?= User::getFotoKetuajurusan(['class' => 'user-image']); ?>
           <?php endif ?>
           <?php if (User::isKeuangan()): ?>
               <?= User::getFotoKeuangan(['class' => 'user-image']); ?>
           <?php endif ?>
           <?php if (User::isWadir()): ?>
               <?= User::getFotoWadir(['class' => 'user-image']); ?>
           <?php endif ?>
       ...
       <ul class="dropdown-menu">
        ...
        <li class="user-header">
           ...
           <p>
            ...
            <small>Politenik Negeri Indramayu 2019</small>
